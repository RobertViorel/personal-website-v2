...
export function Navbar() {
  ...
  return (
    <nav className="top-0 z-50 sticky flex items-center justify-between px-1 py-2 md:px-20 md:pt-3 md:pb-1 shadow-md transition-colors duration-300 bg-primary">
